            ...
            <div class="row">
                <div class="col-12">
                    <h4 class="page-header">
                        <i class="fas fa-globe"></i>Laporan Keseluruhan Data Jabatan <br> PT Gasaba Sukses Mandiri
                    </h4>
                </div>
            </div>
                        ...
                        <tbody>
                            @foreach ($all as $item)
                                <tr align="center">
                                    ...
                                    <td>{{ Sistem::formatRupiah($item->nominal_jabatan) }}</td>
                                </tr>
                            @endforeach

                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card card-primary">
                                    ...
                                    <form id="form" action="{{ url('master/jabatan-store') }}" method="POST">
                                    @csrf
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    <div class="form-group">
                                                        <label for="nm_jabatan">Nama</label>
                                                        <input type="hidden" name="kd_jabatan" id="kd_jabatan">
                                                        <input type="text" class="form-control" id="nm_jabatan" name="nm_jabatan">
                                                    </div>
                                                </div>
                                            </div>

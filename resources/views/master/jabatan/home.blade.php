                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        @if (Auth::user()->level == 'admin')
                                            <a href="{{ url('master/jabatan/form') }}"
                                                class="btn btn-primary float-right"><i class="fas fa-plus"></i> Tambah</a>
                                        @endif

                                        <a href="{{ url('master/jabatan-cetak-all-pdf') }}"
...
@section('js')
    ...
    <script>
        ...
        $('body').on('click', '.delete', function() {
            ...
            var document_kd_jabatan = $(this).data("kd_jabatan");
            swal({
                ...
                .then((result) => {
                    if (result.value) {
                        $.ajax({
                            url: "{{ url('master/jabatan-delete') }}" + '/' + document_kd_jabatan,
                            type: "POST",
                            data: {
                                '_method': 'GET',
                                '_token': csrf_token

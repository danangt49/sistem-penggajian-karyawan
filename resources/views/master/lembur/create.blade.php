                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card card-primary">
                                    ...
                                    <form id="form" action="{{ url('master/lembur-store') }}" method="POST">
                                    @csrf
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="kd_lembur" id="kd_lembur">
                                                        <input type="text" class="form-control" id="nm_lembur" name="nm_lembur">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <div class="form-group">
                                                        <label for="jumlah_jam_lembur">Jumlah Jam</label>
                                                        <input type="number" class="form-control" id="jumlah_jam_lembur" name="jumlah_jam_lembur" onkeyup="total();">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <div class="form-group">
                                                        <label for="biaya_lembur_perjam">Biaya Perjam (Rp.)</label>
                                                        <input type="number" class="form-control" id="biaya_lembur_perjam" name="biaya_lembur_perjam" onkeyup="total();">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <div class="form-group">
                                                        <label for="total_pendapatan_lembur">Total</label>
                                                        <input type="number" class="form-control" id="total_pendapatan_lembur" name="total_pendapatan_lembur" readonly>
                                                    </div>
                                                </div>
                                            </div>

                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card card-primary">
                                    ...
                                    <form id="form" action="{{ url('master/karyawan-update/'.$karyawan->nip) }}" method="POST">
                                    @csrf
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="nm_pegawai" name="nm_pegawai" value="{{ $karyawan->nm_pegawai }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-select rounded-0" id="kd_jabatan" name="kd_jabatan">
                                                            @foreach ( Applib::dd_jabatan() as $key => $value)
                                                                <option value="{{ $key }}" {{ ( $key == $karyawan->kd_jabatan) ? 'selected' : '' }}>{{ $value }}</option>
                                                            @endforeach   
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" id="no_telepon" name="no_telepon" value="{{ $karyawan->no_telepon }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <div class="form-group">
                                                        <label for="gaji_pokok">Gaji Pokok</label>
                                                        <input type="number" class="form-control" id="gaji_pokok" name="gaji_pokok" value="{{ $karyawan->gaji_pokok }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class='input-group date' id='datetimepicker'>
                                                            <input type='text' class="form-control" id="tanggal_masuk" name="tanggal_masuk" value="{{ $karyawan->tanggal_masuk }}"/>
                                                            <span class="input-group-addon">
                                                                <span class="glyphicon glyphicon-calendar"></span>
                                                            </span>
                                                        </div>
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="text" class="form-control" id="alamat" name="alamat">{{ $karyawan->alamat }}</textarea>
                                                    </div>
                                                </div>
                                            </div>

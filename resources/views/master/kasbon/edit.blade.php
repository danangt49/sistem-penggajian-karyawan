                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card card-primary">
                                    ...
                                    <form id="form" action="{{ url('master/kasbon-update/'.$kasbon->kd_kasbon) }}" method="POST">
                                    @csrf
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="keterangan" name="keterangan" value="{{ $kasbon->keterangan }}">
                                                    </div>
                                                </div>
                                            </div>

...
Route::put('/profil-update/{id}', [UserController::class, 'updateProfile'])->name('updateProfile');
Route::put('/password-update/{id}', [UserController::class, 'updatePassword'])->name('updatePassword');
...
Route::put('/gaji-update/{no_slip_gaji}', [GajiController::class, 'update'])->name('update');
...
Route::prefix('master')->middleware('level:user','level:admin')->group(function () {
    ...
    Route::put('/jabatan-update/{kd_jabatan}', [JabatanController::class, 'update'])->name('update');
    ...
    Route::put('/pegawai-update/{nip}', [PegawaiController::class, 'update'])->name('update');
    ...
    Route::put('/kasbon-update/{kd_kasbon}', [KasbonController::class, 'update'])->name('update');
    ...
    Route::put('/kehadiran-update/{kd_kehadiran}', [KehadiranController::class, 'update'])->name('update');
    ...
    Route::put('/lembur-update/{kd_lembur}', [LemburController::class, 'update'])->name('update');
    ...
    Route::put('/tunjangan-skill-update/{kd_tunjangan_skill}', [TunjanganSkillController::class, 'update'])->name('update');
